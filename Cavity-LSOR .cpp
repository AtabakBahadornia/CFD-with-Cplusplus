...
,v[imax+2][jmax+2],Coeff[imax+2][jmax+2],R[imax+2],temp[imax+2],Coeff_psi[imax+2][jmax+2],R_psi[imax];
...
for(int iteration=1;iteration<=6000 && error>ERR && error<1e6 ;iteration++)
{
	counter=counter+1;
